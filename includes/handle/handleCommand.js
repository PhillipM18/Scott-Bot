...
[🐧] → 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 đ𝗮𝗻𝗴 𝗸𝗶́𝗰𝗵 𝗵𝗼𝗮̣𝘁 𝗰𝗵𝗲̂́ đ𝗼̣̂ 𝗤𝘂𝗮̉𝗻 𝘁𝗿𝗶̣ 𝘃𝗶𝗲̂𝗻, 𝗰𝗵𝗶̉ 𝗤𝘂𝗮̉𝗻 𝘁𝗿𝗶̣ 𝘃𝗶𝗲̂𝗻 đ𝘂̛𝗼̛̣𝗰 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗕𝗼𝘁`, _0x587db5.threadID, _0x587db5[_0x93a0xf(0xa9)])
        };
        ...
        if (_0x93a0x27[_0x93a0xf(0xd7)][_0x93a0xf(0xc3)] > _0x93a0x3b) {
            return _0x2f7a9a[_0x93a0xf(0xc0)]('[🐧] → 𝗟𝗲̣̂𝗻𝗵 ' + _0x93a0x27[_0x93a0xf(0xd7)].name + ' 𝗖𝗵𝗶̉ Đ𝘂̛𝗼̛̣𝗰 𝗗𝘂̀𝗻𝗴 𝗩𝗼̛́𝗶 𝗡𝗵𝘂̛̃𝗻𝗴 𝗡𝗴𝘂̛𝗼̛̀𝗶 𝗖𝗼́ 𝗤𝘂𝘆𝗲̂̀𝗻 𝗛𝗮̣𝗻 𝗟𝗮̀ ' + _0x93a0x3f, _0x587db5[_0x93a0xf(0x8b)], _0x587db5[_0x93a0xf(0xa9)])
        };
...
[🐧] → 𝗖𝗵𝗶̉ 𝗔𝗗𝗠𝗜𝗡𝗕𝗢𝗧 𝗺𝗼̛́𝗶 đ𝘂̛𝗼̛̣𝗰 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗯𝗼𝘁 𝘁𝗿𝗼𝗻𝗴 𝗰𝗵𝗮𝘁 𝗿𝗶𝗲̂𝗻𝗴.`, 'set', 'readFileSync', './../../config.json', 'client', 'PREFIX', '24KKyVfc', 'Currencies', `[🐧] → 𝗕𝗮̣𝗻 đ𝗮𝗻𝗴 𝘁𝗿𝗼𝗻𝗴 𝘁𝗵𝗼̛̀𝗶 𝗴𝗶𝗮𝗻 𝗰𝗵𝗼̛̀!\
𝗩𝘂𝗶 𝗹𝗼̀𝗻𝗴 𝘁𝗵𝘂̛̉ 𝗹𝗮̣𝗶 𝘀𝗮𝘂 `, '\\$&', 'sendMessage', 'diemdanh', 'isGroup', 'hasPermssion', '8924730tJtYMV', '../../utils/log.js', './../../modules/commands/cache/data.json', 'adminIDs', 'object', 'adminbox', 'threadNotAllowNSFW', `[🐧]  𝗠𝗜𝗥𝗔𝗜 [🐧]\
[🐧] → 𝗖𝗵𝗶̉ 𝗦𝗨𝗣𝗣𝗢𝗥𝗧 𝗕𝗢𝗧 𝗺𝗼̛́𝗶 𝗰𝗼́ 𝘁𝗵𝗲̂̉ 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗯𝗼𝘁`, 'SUPPORTBOT', 'commandError', 'adminOnly', 'getInfo', 'stringify', 'MODE', 'string-similarity', '13223rfjTvH', 'target', 'executeCommand', 'userBanned', 'config', 'adminPaseOnly', 's nữa nhé!!!', 'match', 'push', 'now', 'findBestMatch', '3TgKZCn', '389412JJoZie', 'hasOwnProperty', 'slice', 'event', '762VEqSTA', 'commandNotExist', 'has', 'ndhOnly', 'writeFileSync', '35iZAPMJ', 'test', 'includes', 'Asia/Ho_Chi_minh', 'handleCommand', 'existsSync', 'threadID', 'join', 'error', 'replace', 'HH:MM:ss DD/MM/YYYY', 'shift', 'bestMatch', 'keys', 'trim', '456878xrvRUt', 'commands', `[🐧] 𝗠𝗜𝗥𝗔𝗜 [🐧]\
[🐧] → 𝗖𝗵𝗶̉ 𝗔𝗗𝗠𝗜𝗡𝗕𝗢𝗧 𝗺𝗼̛́𝗶 𝗰𝗼́ 𝘁𝗵𝗲̂̉ 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗯𝗼𝘁`, 'get', 'cooldowns', 'day', 'find'];
    _0x777b = function () {
        return _0x93a0x51
    };
    return _0x777b()
